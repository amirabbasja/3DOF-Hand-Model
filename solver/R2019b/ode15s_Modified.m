...
%       accepted_local_G(end+1,:) = [tnew;ynew]'; %#ok<AGROW> 
      if hasSMASpring
          savedData(end+1,1:2) = [dynamicSysParams.spring1.force dynamicSysParams.spring2.force]; %#ok<AGROW>
%           savedData_G(end+1,1:2) = [dynamicSysParams.spring1.force dynamicSysParams.spring2.force]; %#ok<AGROW>
